  ...
  const submitHandler = (event) => {
    ...
    if (err.length === 0) {
      axios
        ...
        .catch((err) => {
          /*console.warn(err)*/ setErrorsBack(err.response.data.error); // seteo el estado de errores del back con el error que llego
        });
    } else {
    ...
    <div className={style.container}>
      <div className={style.containerForm}>
        <form className={style.form} onSubmit={submitHandler}>
          <div>
            {errorsBack && (
              <div className={style.errorsBack}> {errorsBack} </div>
            )}
          </div>
          ...
          <div className={style.divs}>
            <div>
              <select
                ...
                name="platform"
                onChange={genresAndPlatformsHandler}
              >
                ...
                {platforms.map((platform) => {
                  return (
                    <option key={platform} name={platform} value={platform}>
                      {platform}
                    </option>
                  );
                })}
          ...
          <div className={style.divs}>
            <div>
              ...
              >
                ...
                {genres.map((genre) => {
                  return (
                    <option key={genre} name={genre} value={genre}>
                      {genre}
                    </option>
                  );
                })}
          ...
          <div className={style.divSubmit}>
            <button className={style.create} type="submit" name="submit">
              CREATE
            </button>
